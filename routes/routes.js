    ...
    console.log(req.file)
        ...
        cryptjs.hash(password,10,function(err,hash){
            ...
            const datas = new User({FirstName:fname,Lastname:lname
                ,PhoneNumber:phone,Username:username,Password:hash,UserType:userType,Profile:profile})
...
router.put('/update',verifyUser,upload.single('profile'),function(req,res){
  const file = req.file
